  ...
  return (
    <>
      ...
      <main className="grain bg-[#05070a] min-h-screen text-white font-body flex flex-col selection:bg-green-500/30">
        ...
        {/* ── NAV ─────────────────────────────────────────────────────────── */}
        <nav className="fixed top-0 w-full z-[100] bg-[#05070a]/80 backdrop-blur-xl h-16 flex items-center justify-between px-4" style={{ position: 'relative' }}>
          <nav className="fixed top-0 w-full z-[100] bg-[#05070a]/80 backdrop-blur-xl h-16 flex items-center justify-between px-4">
            ...
            <div className="flex items-center gap-2.5">
              <div className="relative w-9 h-9 flex items-center justify-center">
                ...
                <div className="relative w-9 h-9 bg-gradient-to-br from-green-400 to-green-600 rounded-xl flex items-center justify-center text-lg shadow-lg">
                  🐉
                </div>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={toggleLang}
                className="btn-press bg-white/5 border border-white/10 w-10 h-8 rounded-xl text-[10px] font-black uppercase transition-all flex items-center justify-center hover:bg-white/10 hover:border-white/20"
              >
                {lang === 'ru' ? 'EN' : 'RU'}
              </button>
            </div>
              ...
              {filteredBikes.map((s, idx) => (
                ...
                >
                  ...
                  <Link href={`/bike/${s.id}`} className="relative aspect-[4/5] w-full overflow-hidden block">
                    ...
                    {s.no_license && (
                      <div className="absolute top-2.5 left-2.5">
                        <div className="bg-green-500 text-black px-2 py-1 rounded-md text-[7px] font-black uppercase tracking-tighter shadow-lg font-display">
                  ...
                  <div className="p-3 flex flex-col">
                    ...
                    <Link
                      href={`/bike/${s.id}`}
                      className="btn-press w-full bg-white text-black py-2.5 rounded-xl font-display font-black text-[10px] uppercase tracking-wide transition-all flex items-center justify-center gap-1 hover:bg-green-400 hover:text-black shadow-md hover:shadow-green-500/20"
                    >
                      {t[lang].btn}
                      <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="opacity-50 -rotate-45 group-hover:rotate-0 transition-transform duration-200">
