...
export default function BikePage() {
  ...
  const t = {
    ru: {
      ...
      specialText: "Для аренды от 11 дней мы согласовываем индивидуальную цену с владельцем. После подтверждения наличия — пришлём вам лучшее предложение в Telegram.",
    ...
    en: {
      ...
      specialText: "For rentals of 11 days or more, we negotiate a personal price with the owner. Once availability is confirmed, we'll send you the best offer via Telegram.",
